...
def is_valid_passport_strict(passport):
    ...
    eyr = has_digits(passport["iyr"], 4) and is_between(2020, passport["eyr"], 2030)
    htg = is_valid_hgt(passport)
    hcl = bool(re.match(r"^#([0-9a-f]{6,6})$", passport["hcl"]))
...
if __name__ == '__main__':
    with open('input4.txt', 'r') as file:
        ...
        print(sum([is_valid_passport_strict(p) for p in passports]))
